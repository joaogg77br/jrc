    ...
    return (
        ...
        ">
            <div className="flex gap-4 py-4">
                ...
                <button className="  hover:bg-[#6A5DA5] cursor-pointer hover:text-white duration-300 rounded-[30px] border-2 border-[#6A5DA5] text-[#6A5DA5] flex items-center justify-center h-[40px] w-[40px]  " onClick={() => {
                    swiper.slideNext()
                    console.log(swiper)
                }}>{next}</button>
            </div>
